    ...
    <section className="py-16">
      <Container>
        <div className="max-w-2xl">
          ...
          <h1 className="mt-3 text-4xl font-semibold text-stone-950">Все товары</h1>
          <p className="mt-4 text-base leading-7 text-stone-700">
            Базовый каталог показывает структуру страниц и компонентов. На следующем этапе
            источником данных станет БД и seed.
          </p>
        </div>
